                            ...
                            @if (PriceHelper::CheckDigital())
                                ...
                                <div class="row">
                                    <div class="col-sm-{{ PriceHelper::checkoutPoliceStationEnabled() ? '6' : '12' }}">
                                        <div class="form-group">
                                            <label for="checkout-country">{{ __('District') }}{{ PriceHelper::checkoutDistrictRequired() ? ' *' : '' }}</label>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control {{ $errors->has('bill_email') ? 'requireInput' : '' }}" name="bill_email" type="email" 
                                            id="checkout_email_billing" value="{{ isset($user) ? $user->email : '' }}" {{ PriceHelper::checkoutEmailRequired() ? 'required' : '' }}>
                                    </div>
                                </div>
                            </div>
                            @endif
