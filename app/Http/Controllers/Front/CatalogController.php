...
class CatalogController extends Controller
{
	...
	public function index(Request $request)
	{
        ...
        // Determine the highlighted product type set by admin (is_type: feature/best/top/new)
        ...
        // If admin has set a highlight product type (is_type), sort it to the top first
        ->when($featuredItemType, function ($query, $featuredItemType) {
            return $query->orderByRaw("CASE WHEN is_type = ? THEN 0 ELSE 1 END", [$featuredItemType]);
        })
